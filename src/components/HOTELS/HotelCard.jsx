...
function HotelCard({ _id, img, name, desc, location, price, rating }) {
  ...
  return (
    <div className="w-56 sm:w-60 md:w-[280px] rounded-2xl overflow-hidden m-3 
      ...
      {/* Glow Border Effect */}
      <div className="absolute inset-0 rounded-2xl p-[2px] bg-[linear-gradient(90deg,#efd5ff_0%,#515ada_100%)] opacity-0 group-hover:opacity-100 transition duration-500 pointer-events-none"></div>
